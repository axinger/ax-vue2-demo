...

  {
    ...
    children: [
      ...
      },
      {
        path: "/test04",
        name: "draw画图-扇形",
        component: () => import("@/views/test/test04_draw.vue"),
        meta: { title: "draw画图-扇形", icon: "form" },
      },
      {
        path: "/test05",
        name: "draw画图-同心圆",
        component: () => import("@/views/test/test05_draw.vue"),
        meta: { title: "draw画图-同心圆", icon: "form" },
      },
      {
        path: "/test12",
        name: "svg图形",
        component: () => import("@/views/test/test12_svg.vue"),
        meta: { title: "svg图形", icon: "form" },
      },
    ],
  },
